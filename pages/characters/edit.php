...
if ($user->getId() == $character->getPlayerId() || $user->isAdmin() || $user->isGm()) {
  ...
  <a href="pages/sheet/create_v<?php echo $character->getVersion(); ?>.php?character_id=<?php echo $characterId; ?>" target="_blank">Generate character sheet</a> |
  <a href="pages/sheet/create_v<?php echo $character->getVersion(); ?>.php?character_id=<?php echo $characterId; ?>&backside=1" target="_blank">Generate 2-page character sheet</a>
